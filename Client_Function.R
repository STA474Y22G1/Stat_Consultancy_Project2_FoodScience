...
Training<-read_csv("Tidy Data.csv") # This is for training set
Testing<-read_csv("Tidy Data.csv") # This is for testing set
...
Data_Analysis<-function(Training, Testing){
  ...
  ## Outputs
  list(Scree_pot=p, Summary_PCA=Summary_PCA, qda_results, confusion_matrix)
}
